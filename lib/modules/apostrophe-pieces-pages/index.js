  ...
  construct: function(self, options) {
    ...
    self.showPage = function(req, callback) {
      ...
      return async.series([
        ...
        req.data.next = next;
        //req.data.pieceSchema = self.pieces.schema;
        req.data.pieceSchema = self.apos.schemas.subset(self.pieces.schema,  self.apos.modules[self.piecesModuleName].options.subsetSchema);
    ...
    self.pushContextPiece = function(req) {
      if (self.pieces.options.contextual && req.data.piece) {
        ...
        req.browserCall('apos.contextFullPiece = ?', req.data.piece);
        req.browserCall('apos.contextSchema = ?', req.data.schema);
      }
    };
